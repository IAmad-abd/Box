                ...
                <div className="tw-flex tw-flex-1 tw-flex-col-reverse md:tw-flex-row tw-mx-auto tw-gap-8 tw-justify-between">
                  <div className="tw-flex tw-flex-col tw-gap-4 tw-flex-grow md:tw-max-w-[40%]">
                    ...
                    <p className="tw-mb-4 tw-text-gray-light">
                                                        A collection of 1555 unique hand drawn Hidden
                                                        Boyz. Living in their own reality from inside the
                                                        bag. Join them on their quest to bring physical
                                                        assets to our virtual world. Stay Hidden.
                    </p>
                    ...
                    <div className="tw-flex tw-flex-col tw-gap-4 tw-flex-grow md:tw-w-[40%]">
                      ...
                      <div>
                        ...
                        <p className="tw-text-gray-light tw-mb-3 tw-text-[16] tx-line-[24]">
                                                                The Hidden Boyz aim to become a recognised
                                                                brand which infiltrates the NFT world. We plan to
                                                                bridge the gap between digital and physical
                                                                assets, for our brand and others within the NFT
                                                                marketplace. As a Hidden Boyz holder you will
                                                                receive additional brand benefits via royalties
                                                                from a variety of different channels alongside a
                                                                potential staking and mutation system. Our
                                                                roadmap is just a glimpse into the future of
                                                                Hidden Boyz, with infinite avenues ahead.
                                                                We will run off a chapter by chapter basis, where
                                                                every phase brings a new infrastructure and
                                                                direction for the brand and its holders.

                                                                With the experience of our design team
                                                                alongside our production team we will
                                                                be providing a service for other communities and
                                                                projects to release their own merch. We will be working
                                                                closely with these projects from design, production,
                                                                sale and shipping. The Merch from these projects will
                                                                also be purchasable through our website, meaning that
                                                                projects can gain other avenues of exposure aside from NFT
                                                                and social media platforms. We truly believe in the power
                                                                of the metaverse, however, we understand that a gap exists between
                                                                the physical and the digital worlds. Being able to create a
                                                                physical presence which represents a community via merch will
                                                                facilitate a system which allows projects to gain credibility
                                                                within the Solana eco-system and NFT space, something which is
                                                                so often doubted. Holders of a project can physically show their
                                                                support for their community, creating a sense of cohesion within
                                                                projects. Hidden Boyz will bridge the gap between the digital
                                                                and physical worlds. Taking projects off the screen and introducing
                                                                them into the real-world collectibles market with the
                                                                Hidden Boyz Launchpad.

                                                                Both holders of Hidden Boyz and consumers will
                                                                benefit from this Merch Launchpad system with percentages
                                                                of royalties distributed to the community fund, growing
                                                                a collaborative and stable eco-system within the
                                                                Solana Market. 1-1 experience and collaborative incentives
                                                                ensures a stable footprint in the Solana infrastructure.
                        </p>
                      </div>
                    </div>
                    <div className="tw-flex tw-flex-col tw-gap-4 tw-flex-grow md:tw-w-[50%]">
                      ...
                      <div className="tw-p-4">
                        <div className="tw-p-4">
                          ...
                          <div className="tw-my-1">
                            <p className="tw-text-gray-light tw-text-md tw-text-[14px]">
                                                                      - Merch launch (graphic tees, hoodies, hats, collectible
                                                                        figures) — portion of the profits will be airdropped to
                                                                        holders
                                                                      - Release of 10 framed 1:1 HiddenBoyz. Verifiable through
                                                                        an NFC tag, proving the authenticity of the products
                                                                      - HiddenGirlz mint (holders of HiddenBoyz will be given
                                                                        whitelist and provided with a discounted mint)
                          ...
                          <div className="tw-my-1">
                            <p className="tw-text-gray-light tw-text-md tw-text-[14px]">
                                                                      ...
                                                                      - Merch launchpad — portion of profits will be airdropped
                                                                        to holders
                                                                      - Market merchandise and launchpad
                          ...
                          <div className="tw-my-1">
                            ...
                            <br />
                                                                ...
                                                                <div className="tw-my-1">
                                                                    <p className="tw-text-gray-light tw-text-md tw-text-[14px]">
                                                                        Our Roadmap is just a glimpse into the future of Hidden Boyz,
                                                                        with infinite avenues ahead. We will run off a chapter
                                                                        by chapter basis, where every phase brings a new infrastructure and
                                                                        direction for the brand and it’s holders.
                                                                    </p>
                                                                    <br />
                                                                </div>
